                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="d-xl-flex justify-content-between align-items-start">
                            <h2 class="text-dark font-weight-bold mb-2"> Update & Delete Movie </h2>
...
//                echo "<td>" . $row['gs'] . "</td>";
                echo "<td>" . $row['seat'] . "</td>";
                echo "<td>
                        <a href='update_movie.php?id=" . $row['id'] . "' class='update-btn'>Update</a>
                        <span class='btn-divider'></span>
                        <a href='delete_movie.php?id=" . $row['id'] . "' class='delete-btn'>Delete</a>
                      </td>";
                echo "</tr>";
            }
        } else {
    ...
    <a href="insert_movie.php" class="add-movie-btn">Add Movie</a>
</body>
</html>
