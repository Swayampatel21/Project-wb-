                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <div class="d-xl-flex justify-content-between align-items-start">
                            <h2 class="text-dark font-weight-bold mb-2"> View Reports </h2>
...
<body>
    <div class="container">
        <a href="mrr.php" class="btn">Rating Report</a>
         <a href="booking_report.php" class="btn">Booking Report</a><br/><br/>
          <a href="payment_report.php" class="btn">Payment Report</a>
           <a href="cancellation_report.php" class="btn">Cancellation Report</a>
    </div>
</body>
</html>
